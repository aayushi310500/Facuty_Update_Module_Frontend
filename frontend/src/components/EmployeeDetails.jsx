...
// import React, { useState, useEffect } from "react";
// import { useNavigate } from "react-router-dom";
// import { useCourseContext } from "../components/CourseContext"; // Assuming this context provides courses

// const EmployeeDetails = () => {
//   const { courses } = useCourseContext(); // Get courses from the context
//   const [employee, setEmployee] = useState(null); // Employee details state
//   const [loading, setLoading] = useState(true); // Loading state
//   const [error, setError] = useState(null); // Error state
//   const [successMessage, setSuccessMessage] = useState(null); // Success message state
